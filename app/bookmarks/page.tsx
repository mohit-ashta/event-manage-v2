...
import { Bookmark, Calendar, MapPin, Clock, ArrowLeft } from "lucide-react"
      ...
      <header className="border-b bg-card">
        <div className="container mx-auto px-4 py-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl font-bold text-balance">My Bookmarks</h1>
              <p className="text-muted-foreground mt-1">
                {bookmarkedEvents.length} event{bookmarkedEvents.length !== 1 ? "s" : ""} you've bookmarked
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="container mx-auto px-4 py-8">
        {bookmarkedEvents.length > 0 ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-muted-foreground mb-6">Bookmark events you want to remember and they'll appear here.</p>
            <Link href="/">
